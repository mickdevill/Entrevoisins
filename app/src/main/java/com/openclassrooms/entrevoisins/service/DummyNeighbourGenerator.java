...
public abstract class DummyNeighbourGenerator {
    ...
    public static List<Neighbour> DUMMY_NEIGHBOURS = Arrays.asList(
            ...
            new Neighbour(11, "Taisson", "http://i.pravatar.cc/150?u=a042581f4e29026702d"),
            new Neighbour(12, "Ludovic", "http://i.pravatar.cc/150?u=a042581f3e39026702d"),
            new Neighbour(13, "Kazuma kun", "https://cloudedanime.files.wordpress.com/2017/03/konosuba-2-09-01-exasperated-kazuma.jpg")
    );
